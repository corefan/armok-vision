...
{
internal class ArmokShaderGUI : ShaderGUI
{
	...
	private static class Styles
	{
		...
		public static GUIContent occlusionText = new GUIContent("Occlusion Strength", "");
		...
		EditorGUI.BeginChangeCheck();
		{
			...
			EditorGUILayout.Space();
                ...
                if (!bUnlit)
                {
                    ...
                    {
                        m_MaterialEditor.ShaderProperty(occlusionStrength, Styles.occlusionText.text, 2);
	...
	static void SetMaterialKeywords(Material material)
	{
		...
		SetKeyword( material, "S_OCCLUSION", material.GetTexture("_BumpMap") );
